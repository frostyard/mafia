...
class RunState(StrEnum):
    ...
    ADJUDICATING_IMPLEMENTATION = "adjudicating_implementation"
    REMEDIATING_IMPLEMENTATION = "remediating_implementation"
    VERIFYING_REMEDIATION = "verifying_remediation"
    PR_OPEN = "pr_open"
...
class ArtifactKind(StrEnum):
    ...
    IMPLEMENTATION_REVIEW_LEDGER = "implementation_review_ledger"
